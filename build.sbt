...
libraryDependencies += "org.scalamock" % "scalamock-scalatest-support_2.10" % "3.2" % "test"
libraryDependencies += "org.scalanlp" % "breeze_2.10" % "0.9"
libraryDependencies += "org.scala-lang" % "scala-library" % "2.10.4" % "provided"
libraryDependencies += "com.twitter" % "parquet-hadoop" % "1.6.0" % "provided"
libraryDependencies += "com.twitter" % "parquet-hive-bundle" % "1.6.0" % "provided"
